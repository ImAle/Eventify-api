...
<body class="bg-gray-100">
    ...
    <main class="container mx-auto mt-10 text-center">
        ...
        <!--<a href="{{ url('/events') }}" class="text-2xl font-bold text-gray-700">Consulta los eventos disponibles</a>-->
        <br>
        <button onclick="window.location.href='{{ url('/events') }}'" class="btn btn-primary font-bold text-gray-700">
            Consulta los eventos disponibles aquí.
        </button>
    </main>
</body>
</html>
